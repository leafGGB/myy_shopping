...
(function() {
    ...
    left_btn.onclick = function() {
        ...
        if(idx == 0) {
            ...
            //小技巧，延时毫秒非常有用，可以让刚才的瞬移发生之后，再把过渡加上
            setTimeout(function() {
                //加上过渡
                carousel_list.style.transition = 'transform .5s ease 0s';
                //动画
    ...
    function setCircles() {
        ...
        for(var i = 0; i <= 4; i++) {
            //这里的%5非常巧妙，0、1、2、3、4除以5都是它本身，但是5除以5等于0
            //这里的%5目的就是为了右按钮它有一瞬间，idx会成为5，500毫秒之后才变为0
            if(i == idx % 5) {
